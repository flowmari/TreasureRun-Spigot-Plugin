...
Key gameplay modules include:
- Sea-stage generation (neon-style floor), chest spawning, scoring & ranking
- Reward/effect sequences for top ranks
- “TreasureShop” trading element
- Persistent data storage (DB integration)
