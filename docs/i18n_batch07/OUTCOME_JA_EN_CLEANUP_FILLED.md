# OutcomeMessageService ja/en cleanup draft

このファイルは **Phase B-1: ja/en cleanup** 用の下書きです。
ここで英語原文と日本語原文を整え、その後に languages/*.yml へ移します。

## BOOST_SUCCESS_HIGH

### BOOST_SUCCESS_HIGH_01
...
記録は深く刻まれ、風もそれを消せなかった。

**en**

The record was carved in deep,
and even the wind could not erase it.
...
調和が戻り、すべてはこの瞬間のためにあったと知れた。

**en**

Harmony returned,
and everything proved to have led to this moment.
...
時間は静かに流れ、記憶の隅へと収まっていった。

**en**

Time slipped by in silence,
settling into the corners of memory.
...
空の色が移ろい、一つの物語が終わりへ届いた。

**en**

The sky changed color,
and one story reached its end.
